...
let initWebRoutes = (app) =>{
    ...
    router.post('/post-crud', homeController.postCRUD); // tạo
    router.get('/get-crud', homeController.displayGetCRUD); // lấy
    router.get('/edit-crud', homeController.getEditCRUD); // sửa
    router.post('/put-crud', homeController.putCRUD); // cập nhật
